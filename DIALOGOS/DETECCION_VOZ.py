...
def eventos_voz(filename, frame_dur, aggressiveness):
...
if __name__ == "__main__":
    ...
    for filename in ['/home/nofi/DESARROLLO/PROYECTOS/ASISTENTE DE SONIDO/POSTPRODUCCIÓN/ESA/DIALOGOS/chunk-03.wav']:
        print("Checking", filename)
        events = eventos_voz(filename, args.frame_duration, args.aggressiveness)
        print(events)
